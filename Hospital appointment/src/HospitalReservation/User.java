...
public class User implements ILookUpAppointment {
	...
	public User(String authority, int ID, String firstname, String lastname, long phone, String username,
			String password) {
	...
	public String getInfoString() {
		return this.authority + "," + this.ID + "," + this.firstName + "," + this.lastName + "," + this.phoneNumber
