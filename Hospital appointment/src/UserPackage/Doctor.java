...
public class Doctor extends User implements ILookUpAppointment {
	...
	public void lookupPendingRequest(AppointmentList list1, UserList userListData, String appointmentLocation,
	...
	public void moveAppointment(AppointmentList list1, UserList userListData, String appointmentLocation)
			throws IOException {
		Scanner input = new Scanner(System.in);
	...
	public void addNewAppointment(AppointmentList list1, UserList userListData, String appointmentLocation)
			throws IOException {
		Scanner input = new Scanner(System.in);
